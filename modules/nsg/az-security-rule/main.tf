resource "azurerm_network_security_rule" "custom_rules" {
  ...
  source_port_range                          = "*"
  destination_port_range                     = lookup(var.custom_rules[count.index], "destination_port_ranges", null) == null ? lookup(var.custom_rules[count.index], "destination_port_range", "*") : null
  destination_port_ranges                    = lookup(var.custom_rules[count.index], "destination_port_range", null) == null ? split(",", lookup(var.custom_rules[count.index], "destination_port_ranges", "*")) : null
